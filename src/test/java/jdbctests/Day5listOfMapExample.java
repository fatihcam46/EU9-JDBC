...
public class Day5listOfMapExample {
...
//this map we are adding >> put() manually>>
        row1.put("first_name","Steven");
        row1.put("last_name","King");
        row1.put("salary",24000);//I put Object >>i can do integer ,String  also
...
//1st get is list >>2nd get is map
        System.out.println(queryData.get(1).get("salary"));//17000
    }
    ...
    public void test2() throws SQLException {
        ...
        //rsmd.getColumnName(1):first_name resultSet.getString:Neena
